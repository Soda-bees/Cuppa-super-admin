            ...
            <div className=' md:pl-[18%] sm:pl-[19%] pl-[22%] py-4 pr-4'>
                <div className=''>
                    <div className='relative mb-4 sm:mb-6 md:mb-10'>
                        ...
                        <input placeholder='search' value={search} className='w-[100%] border-2 border-borderColor rounded-xl cursor-pointer bg-transparent p-2 pl-8 text-md md:text-xl outline-none'
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2'>
                        {outlet?.length > 0 && currentProducts
                            ?.filter((item) => {
