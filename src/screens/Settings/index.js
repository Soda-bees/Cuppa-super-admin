...
export default function Settings() {
    ...
    return (
        <div className='xl:pl-[17%] md:pl-[19%] sm:pl-[19
        npm%] pl-[22%] py-4'>
            ...
            <div className='flex justify-between items-center w-[95%] sm:w-[60%] mt-4 sm:mt-10'>
                ...
                <div >
                    <div className='px-6 py-1 bg-gradient-to-r from-green to-darkerGreen text-white rounded-xl cursor-pointer active:opacity-50'>Save</div>
                </div>
            </div>
            <div className='w-[95%] sm:w-[60%] bg-bgSettings py-8 rounded-xl mt-4'>
                ...
                <div className='flex flex-col items-center md:flex-row md:gap-4 sm:justify-center md:mb-4'>
                    <div className='w-[95%] md:w-[45%] bg-white rounded-xl mt-2 p-2'>
                        <div className='text-sm md:text-lg text-textColor'>
                            Contact
                        </div>
                        <PhoneInput
            ...
            <div className='w-[95%] sm:w-[60%] bg-bgSettings py-8 rounded-xl mt-4'>
                <div className='text-md sm:text-xl font-semibold ml-5 md:ml-7 xl:ml-10 mb-2'>Create Your New Password</div>
            ...
            <div className='w-[95%] sm:w-[60%] flex justify-end mt-4'>
                <div onClick={handleLogout} className='cursor-pointer active:opacity-50 px-6 py-2 bg-gradient-to-r from-green to-darkerGreen text-white rounded-xl 
